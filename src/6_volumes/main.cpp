...
void PopulateSceneObjects( const gm::FloatRange& i_shutterRange, raytrace::SceneObjectPtrs& o_sceneObjects )
{
    ...
    // Constant mediums.
    raytrace::SceneObjectPtr box0 = std::make_shared< raytrace::Box >( /* origin */ gm::Vec3f( 215, 75, 115 ),
                                                                       /* dimensions */ gm::Vec3f( 150, 150, 150 ),
                                                                       /* material */ whiteLambert );
    raytrace::SceneObjectPtr box1 = std::make_shared< raytrace::Box >( /* origin */ gm::Vec3f( 345, 150, 375 ),
                                                                       /* dimensions */ gm::Vec3f( 150, 295, 150 ),
                                                                       /* material */ whiteLambert );
    ...
    o_sceneObjects.push_back( std::make_shared< raytrace::ConstantMedium >(
        /* geometry */ box1,
        /* density */ 0.01f,
        std::make_shared< raytrace::ConstantTexture >( gm::Vec3f( 0, 0, 0 ) ) ) );
}
...
int main( int i_argc, char** i_argv )
{
    ...
    cxxopts::Options options( "6_volumes", "Ray tracing program adding volumes with density modeling." );
    options.add_options()                                                                       // Command line options.
        ...
        ( "s,samplesPerPixel",
          ...
          cxxopts::value< int >()->default_value( "200" ) ) // Number of samples.
        ( "b,rayBounceLimit",
